 ...
 *
 */
@SuppressWarnings("serial") // We're not serializing.
public class StringSet extends ArrayList<String>
{
	...
	// an accessor that returns the total number of characters in all of the
	// Strings that have been added to this StringSet object
	public int numChars()
	{
		int numCharacters = 0;
	...
	// an accessor that returns the number of Strings in the StringSet object
