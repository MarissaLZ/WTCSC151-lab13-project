...
public class StringSetTester {
	...
	public static void main(String[] args) {
		 ...
		 System.out.println( "The current number of strings is: " + stringSet2.size());		 
		 System.out.println( "The number of characters is: " + stringSet2.numChars());
		 //stringSet2.pop();
		 System.out.print("Enter a string to search for: ");
		 String substring = kybd.nextLine();
		 
		 System.out.print( "The number of strings that contain the given string are: " + stringSet2.countStrings(substring) );
		 
		 StringSetSanityCheck.SanityCheck();
